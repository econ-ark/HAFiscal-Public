...
# This script filters out packages that are in scheme-minimal (which are already installed)
...
# Extract packages marked as "standalone" OR "collection-latex" (exclude only scheme-minimal)
