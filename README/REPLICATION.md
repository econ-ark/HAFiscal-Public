...
**Version**: v2025-12-24-10-31-12-gb2a0897b
...
> **Note**: Detailed information about data sources, methodology, and generation scripts for each figure is contained in the corresponding `.tex` subfile listed below.

Figures are defined as LaTeX subfiles that include generated PDFs from the computational code.

| Fig # | Figure Subfile | Caption | Source PDFs | Generated By |
|-------|----------------|---------|-------------|--------------|
| 1 | `Figures/splurge_estimation.tex` | Splurge factor estimation | `Code/HA-Models/Target_AggMPCX_LiquWealth/Figures/AggMPC_LotteryWin_comparison.pdf`, `LiquWealth_Distribution_comparison.pdf` | `Estimation_BetaNablaSplurge.py` |
| 2 | `Code/HA-Models/FromPandemicCode/LorenzPts.tex` | Wealth distribution fit by education group | `Code/HA-Models/FromPandemicCode/LorenzPoints_CRRA_2.0_R_1.01.pdf` | `CreateLPfig.py` |
| 3 | `Figures/untargetedMoments.tex` | Non-targeted moments validation | `Code/HA-Models/FromPandemicCode/IMPCs_wSplEstimated.pdf`, `Figures/UnempSpell_Dynamics.pdf` | `AggFiscalMAIN.py` → `Output_Results.py` |
| 4 | `Figures/Policyrelrecession.tex` | Policy effectiveness during recessions | `Code/HA-Models/FromPandemicCode/Figures/recession_*_relrecession.pdf`, `Cumulative_multiplier_*.pdf` | `AggFiscalMAIN.py` → `Output_Results.py` |
| 5 | `Figures/HANK_IRFs.tex` | HANK-SAM model IRFs and multipliers | `Code/HA-Models/FromPandemicCode/Figures/HANK_*_IRF.pdf`, `HANK_*_multiplier.pdf` | `HA-Fiscal-HANK-SAM-to-python.py` |
| 6 | `Figures/HANK_multipliers.tex` | PE vs HANK multiplier comparison | `Code/HA-Models/FromPandemicCode/Figures/Cumulative_multipliers_withHank.pdf` | `HA-Fiscal-HANK-SAM-to-python.py` |

**Appendix Figures** (in `Subfiles/Appendix-NoSplurge.tex`):

| Fig # | Figure Subfile | Caption | Generated By |
|-------|----------------|---------|--------------|
| A.1 | `Figures/splurge0_Norwayestimation.tex` | Estimation without splurge factor | `Estimation_BetaNablaSplurge.py` (splurge=0 variant) |
| A.2 | `Figures/untargetedMoments_wSplZero.tex` | Non-targeted moments (no splurge) | `AggFiscalMAIN.py` (splurge=0 variant) |
| A.3 | `Figures/cumulativemultipliers_SplurgeComp.tex` | Multiplier comparison: with vs without splurge | `AggFiscalMAIN.py` → `Output_Results.py` |

**Note**: Each `.tex` file in `Figures/` is a standalone LaTeX subfile that can be compiled independently. The PDFs they include are generated by Python scripts in `Code/HA-Models/`.

### Tables

> **Note**: Detailed information about data sources, methodology, and generation scripts for each table is contained in the corresponding `.tex` subfile listed below.

Tables are defined as LaTeX subfiles in `Tables/` that pull generated content via `\fetchgeneratedtabular{}`.

| Tbl # | Table Subfile | Caption | Generated Content Source | Generated By |
|-------|---------------|---------|--------------------------|--------------|
| 1 | `Tables/MPC_WQ.tex` | MPC by wealth quartile | `Code/HA-Models/Target_AggMPCX_LiquWealth/Figures/MPC_WealthQuartiles_Table.ltx` | `Estimation_BetaNablaSplurge.py` |
| 2 | `Tables/calibration.tex` | Model calibration parameters | Hardcoded in LaTeX | Manual documentation |
| 3 | `Tables/calibrationRecession.tex` | Recession parameters | Hardcoded in LaTeX | Manual documentation |
| 4 | `Tables/estimBetas.tex` | Estimated discount factors | `Code/HA-Models/FromPandemicCode/Tables/CRRA2/estimBetas.ltx` | `AggFiscalMAIN.py` |
| 5 | `Tables/nonTargetedMoments.tex` | Non-targeted moments | `Code/HA-Models/FromPandemicCode/Tables/CRRA2/nonTargetedMoments.ltx` | `AggFiscalMAIN.py` |
| 6 | `Tables/Multiplier.tex` | Policy multipliers | `Code/HA-Models/FromPandemicCode/Tables/CRRA2/Multiplier.ltx` | `AggFiscalMAIN.py` → `Output_Results.py` |
| 7 | `Tables/welfare6.tex` | Welfare effectiveness | `Code/HA-Models/FromPandemicCode/Tables/CRRA2/welfare6.ltx` | `AggFiscalMAIN.py` → `Welfare.py` |
| 8 | `Tables/welfare6-SplurgeComp.tex` | Welfare comparison (splurge) | `Code/HA-Models/FromPandemicCode/Tables/Splurge0/welfare6_SplurgeComp.ltx` | `AggFiscalMAIN.py` → `Welfare.py` |

**Appendix Tables** (in `Subfiles/Appendix-NoSplurge.tex`):

| Tbl # | Table Subfile | Description | Generated By |
|-------|---------------|-------------|--------------|
| A.1 | `Tables/Comparison_Splurge_Table.tex` | Splurge factor comparison | Manual documentation |
| A.2 | `Tables/nonTargetedMoments_wSplZero.tex` | Non-targeted moments without splurge | `AggFiscalMAIN.py` (splurge=0 variant) |
| A.3 | `Tables/Multiplier_SplurgeComp.tex` | Multiplier comparison with/without splurge | `AggFiscalMAIN.py` → `Output_Results.py` |

**Note**: Each `.tex` file in `Tables/` is a standalone LaTeX subfile. Generated `.ltx` files are created by Python scripts and pulled in via `\fetchgeneratedtabular{}`.
...
**README Version**: 1.1  
**Replication Package Version**: v2025-12-24-10-31-12-gb2a0897b
