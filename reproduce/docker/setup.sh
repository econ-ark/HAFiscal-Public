...
# Format: .venv-{platform}_{arch}
# Examples: .venv-linux_x86_64, .venv-darwin_arm64
PLATFORM_VENV=""
PLATFORM=""
ARCH=""
...
# Set platform-specific venv path with architecture
if [ -n "$PLATFORM" ]; then
    PLATFORM_VENV=".venv-${PLATFORM}_${NORMALIZED_ARCH}"
else
    PLATFORM_VENV=".venv"
fi
