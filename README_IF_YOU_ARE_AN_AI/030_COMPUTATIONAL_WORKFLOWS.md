...
The computational pipeline implements **5 sequential steps** that take **4-5 days on a high-end 2025 laptop** to complete fully.
...
```python
# For complete replication (expect 4-5 days on a high-end 2025 laptop):
...
./reproduce.sh --comp full # Runs complete computational workflow (4-5 days on a high-end 2025 laptop)
```
