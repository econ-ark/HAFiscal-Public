...
**Important**: Always work in `HAFiscal-Latest`, never directly in `econ-ark/HAFiscal`.
...
#    Go to: https://github.com/llorracc/HAFiscal-Latest
...
| **Full replication** | `./reproduce.sh --comp full` | 3-4 days | Medium |
...
**Version**: 1.0  
**Last Updated**: 2025-11-16  
**Feedback**: Open an issue at https://github.com/econ-ark/HAFiscal/issues
